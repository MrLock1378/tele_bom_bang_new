...
local function info_cb(arg, data)
  ...
  lastname = ""
   ...
   local text = "_▪️Your name :_ *"..firstname.."*\n_▪️Your Last name :_ *"..lastname.."*\n_▪️Your Username :_ "..username.."\n_▪️Your ID :_ *"..data.id_.."*\n\n"
		    if data.id_ == tonumber(Solid) then
		       text = text..'_▪️Your Rank :_ *Executive Admin*\n\n'
			   elseif is_sudo1(data.id_) then
	           text = text..'_▪️Your Rank :_ *Full Access Admin*\n\n'
		     elseif is_admin1(data.id_) then
		       text = text..'_▪️Your Rank :_ *Bot Admin*\n\n'
		     elseif is_owner1(arg.chat_id, data.id_) then
		       text = text..'_▪️Your Rank :_ *Group Owner*\n\n'
		     elseif is_mod1(arg.chat_id, data.id_) then
		       text = text..'_▪️Your Rank :_ *Group Moderator*\n\n'
		 else
		       text = text..'_▪️Your Rank :_ *Group Member*\n\n'
			end
         local user_info = {} 
  ...
  text = text..'▪️тσтαℓ мєѕѕαgєѕ : '..user_info_msgs..'\n\n'
...
local function info_by_username(arg, data)
  ...
  lastname = ""
   ...
   local text = "_▪️Your name :_ *"..firstname.."*\n_▪️Your Last name :_ *"..lastname.."*\n_▪️Your Username :_ "..username.."\n_▪️Your ID :_ *"..data.id_.."*\n\n"
		    if data.id_ == tonumber(Solid) then
		       text = text..'_▪️Your Rank :_ ▪️*Executive Admin*\n\n'
			   elseif is_sudo1(data.id_) then
	           text = text..'_▪️Your Rank :_ ▪️*Full Access Admin*\n\n'
		     elseif is_admin1(data.id_) then
		       text = text..'_▪️Your Rank :_ ▪️*Bot Admin*\n\n'
		     elseif is_owner1(arg.chat_id, data.id_) then
		       text = text..'_▪️Your Rank :_ ▪️*Group Owner*\n\n'
		     elseif is_mod1(arg.chat_id, data.id_) then
		       text = text..'_▪️Your Rank :_ ▪️*Group Moderator*\n\n'
		 else
		       text = text..'_▪️Your Rank :_ ▪️*Group Member*\n\n'
			end
         local user_info = {} 
  local uhash = 'user:'..data.id_
  local user = redis:hgetall(uhash)
...
if matches[1] == "info" or matches[1] == "Info" or matches[1] == "اطلاعات من" then
